...
stock_flow_timeseries = pd.read_excel(
    'MFA_II_tutorial_II.xlsx', sheet_name='inflow_driven')
...
curve_surv_matrix = scipy.signal.convolve2d(np.diagflat(
    stock_flow_timeseries.loc[:, 'inflow']), curve_surv.reshape(-1, 1))
